...
def arg_parse():
    ...
    parser.add_argument("-d", "--dataset-dir", type=str, default="/share/private/27th/hirotaka_saito/dataset/sq2/d_kan1/vpr_ibag_10_3")
    parser.add_argument("-td", "--test-dataset-dir", type=str, default="/share/private/27th/hirotaka_saito/dataset/sq2/d_kan1/vpr_path_10_3")
    ...
    parser.add_argument("-pn", "--pile-num-img", type=int, default=10)
    parser.add_argument("-i", "--checkpoint_dir", type=str, default="./checkpoint_dirs")
